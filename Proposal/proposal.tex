...
\vspace{20mm}
\centerline{\large{A Thesis submitted to the Faculty of Graduate Studies if the}}
\vspace{5mm}
\centerline{\large{University of Manitoba}}
\vspace{5mm}
\centerline{\large{in partial fulfilment of the requirements for the degree of}}
\vspace{13mm}
