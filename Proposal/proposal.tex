...
channels (including DNS tunnels) can be used for is:
...
Preventing botnets from operating is of the best interest for the Internet as a
...
%that normal DNS traffic has a unique %character frequency distribution that can
be used as a discriminating %fingerprint. Based on analysis of common domain
names, he obtained a %distribution that accurately describes normal DNS traffic
while %effectively detecting DNS tunnel traffic. Results obtained by Born
indicate %that DNS tunnels have an approximately uniform character frequency
distribution %whereas normal DNS queries do not.
...
\newpage \chapter{Review of the State of the Art} \label{litreview}
...
\chapter{Probabilistic Encoding} \label{probencode} Several detection methods in
