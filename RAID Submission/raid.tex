...
\begin{figure}
\centering
\subfigure[Performance of Analysis Method and Python Interpreter on Real World Data]{\includegraphics[width=0.48\textwidth]{../figures/pmqr.pdf}\label{pmqr}}
\subfigure[Performance of Analysis Method and Python Interpreter on Real World Data - Early Time]{\includegraphics[width=0.48\textwidth]{../figures/pmqr-100k.pdf}\label{pmqr-100k}}
\end{figure}
...
\subfigure[Certainty of detection - 0.95 to 1.00]{\includegraphics[width=0.48\textwidth]{../figures/cplot3.pdf}\label{cplot95}}
