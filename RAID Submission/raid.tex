...
\begin{figure}
\centering
\subfigure[Chart of Certainty of Detection by Tunnel Application and Detection Method - 0.80 to 1.00]{\includegraphics[width=0.48\textwidth]{../figures/cplot2.pdf}\label{cplot80}}
\subfigure[Chart of Certainty of Detection by Tunnel Application and Detection Method - 0.95 to 1.00]{\includegraphics[width=0.48\textwidth]{../figures/cplot3.pdf}\label{cplot95}}
\end{figure}
